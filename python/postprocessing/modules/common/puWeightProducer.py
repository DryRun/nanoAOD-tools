...
pufile_mc="%s/src/PhysicsTools/NanoAODTools/data/pileup/pileup_profile_Summer16.root" % os.environ['CMSSW_BASE']
pufile_data="%s/src/PhysicsTools/NanoAODTools/data/pileup/PileupData_GoldenJSON_Full2016.root" % os.environ['CMSSW_BASE']
puWeight = lambda : puWeightProducer(pufile_mc,pufile_data,"pu_mc","pileup",verbose=False)

pufile_data2017="%s/src/PhysicsTools/NanoAODTools/data/pileup/pileup_Cert_294927-306462_13TeV_PromptReco_Collisions17_withVar.root" % os.environ['CMSSW_BASE']
