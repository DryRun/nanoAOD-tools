...
from PhysicsTools.NanoAODTools.postprocessing.modules.jme.inputFiles import GetJERInputPath, GetJERUncertaintyPath, GetJESUncTotalPath, GetJESUncSourcesPath, GetGlobalTag
...
class jetmetUncertaintiesProducer(Module):
	def __init__(self, 
		...
		self._gt = GetGlobalTag(self.era)
		self.jerInputFileName = GetJERInputPath(self.era, jetType)
		self.jerUncertaintyInputFileName = GetJERUncertaintyPath(self.era, jetType)

		self.jetSmearer = jetSmearer(self._gt, jetType, self.jerInputFileName, self.jerUncertaintyInputFileName)

		if jetType in [JetType.kAK4PF, JetType.kAK4PFchs, JetType.kAK4PFPuppi]:
			self.jetBranchName = "Jet"
			self.genJetBranchName = "GenJet"
			self.genSubJetBranchName = None
			self.doGroomed = False
			self.corrMET = True
		elif jetType in [JetType.kAK8PF, JetType.kAK8PFchs, JetType.kAK8PFPuppi]:
			...
			raise ValueError("ERROR: Invalid jet type = '%s'!" % JetTypeString(jetType))
		...
		if len(jesUncertainties) == 1 and jesUncertainties[0] == "Total":
			self.jesUncertaintyFileName = GetJESUncTotalPath(self.era, jetType)
		else:
			self.jesUncertaintyFileName = GetJESUncSourcesPath(self.era, jetType)

		# read all uncertainty source names from the loaded file
		if jesUncertainties[0] == "All":
			with open(self.jesUncertaintyFileName) as f:
				lines = f.read().split("\n")
	...
	def beginJob(self):
		print("Loading jet energy scale (JES) uncertainties from file {}".format(self.jesUncertaintyFileName))
		...
		for jesUncertainty in self.jesUncertainties:
			...
			if self.era == Year.k2016 and jesUncertainty == 'Total' and len(self.jesUncertainties) == 1:
				jesUncertainty_label = ''
			#pars = ROOT.JetCorrectorParameters(self.jesUncertaintyInputFileName, jesUncertainty_label)
			#self.jesUncertainty[jesUncertainty] = ROOT.JetCorrectionUncertainty(pars)    
			self.jesUncertainty[jesUncertainty] = ROOT.JetCorrectionUncertainty(self.jesUncertaintyFileName)    
...
jetmetUncertainties2016 = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_07Aug2017_V11_MC", ["Total"])
jetmetUncertainties2016All = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_07Aug2017_V11_MC", ["All"])
jetmetUncertainties2017 = lambda : jetmetUncertaintiesProducer(Year.k2017, "Fall17_17Nov2017_V32_MC", ["Total"])
jetmetUncertainties2017All = lambda : jetmetUncertaintiesProducer(Year.k2017, "Fall17_17Nov2017_V32_MC", ["All"], redoJEC=True)
jetmetUncertainties2018 = lambda : jetmetUncertaintiesProducer("2018", "Autumn18_V3_MC", ["Total"])
jetmetUncertainties2018All = lambda : jetmetUncertaintiesProducer("2018", "Autumn18_V3_MC", ["All"], redoJEC=True)

jetmetUncertainties2016AK4Puppi = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_23Sep2016V4_MC", ["Total"], jetType="AK4PFPuppi")
jetmetUncertainties2016AK4PuppiAll = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_23Sep2016V4_MC",  ["All"], jetType="AK4PFPuppi")
jetmetUncertainties2017AK4Puppi = lambda : jetmetUncertaintiesProducer(Year.k2017, "Fall17_17Nov2017_V6_MC", ["Total"], jetType="AK4PFPuppi")
jetmetUncertainties2017AK4PuppiAll = lambda : jetmetUncertaintiesProducer(Year.k2017, "Fall17_17Nov2017_V6_MC",  ["All"], jetType="AK4PFPuppi")

jetmetUncertainties2016AK8Puppi = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_23Sep2016V4_MC", ["Total"], jetType="AK8PFPuppi")
jetmetUncertainties2016AK8PuppiAll = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_23Sep2016V4_MC",  ["All"], jetType="AK8PFPuppi")
jetmetUncertainties2016AK8PuppiNoGroom = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_23Sep2016V4_MC", ["Total"], jetType="AK8PFPuppi",redoJEC=False,noGroom=True)
jetmetUncertainties2016AK8PuppiAllNoGroom = lambda : jetmetUncertaintiesProducer(Year.k2016, "Summer16_23Sep2016V4_MC", ["All"], jetType="AK8PFPuppi",redoJEC=False,noGroom=True)
jetmetUncertainties2017AK8Puppi = lambda : jetmetUncertaintiesProducer(Year.k2017, "Fall17_17Nov2017_V6_MC", ["Total"], jetType="AK8PFPuppi")
jetmetUncertainties2017AK8PuppiAll = lambda : jetmetUncertaintiesProducer(Year.k2017, "Fall17_17Nov2017_V6_MC", ["All"], jetType="AK8PFPuppi")
